...
export const onboardingData: OnboardingSlide[] = [
  {
    ...
    description:
      "Tambah, edit, dan kelola produk Anda dengan cepat dan efisien. Pantau stok barang secara real-time.",
    color: "#FF9228",
  },
  {
    id: 2,
    ...
    description:
      "Proses transaksi penjualan dengan cepat. Cetak struk langsung dari aplikasi untuk kemudahan Anda.",
    color: "#10B981",
  },
  {
    id: 3,
    ...
    description:
      "Dapatkan insight bisnis Anda dengan laporan penjualan, stok, dan keuntungan yang detail dan real-time.",
    color: "#3B82F6",
  },
  {
    id: 4,
    ...
    description:
      "Akses aplikasi POS Anda kapan saja dan dimana saja. Kelola bisnis Anda dengan mudah dari smartphone.",
    color: "#8B5CF6",
  },
];
