...
export default function Transaction() {
  ...
  const todayFiltered = useMemo(() => {
    ...
    return filtered.filter((r) =>
      r.createdAt ? isSameDay(r.createdAt, today) : false,
    );
  }, [filtered]);
    ...
    <View className="flex-1 bg-white">
      <ScrollView
        ...
        contentContainerStyle={{
          paddingBottom: todayFiltered.length > 0 ? 20 : 0,
        }}
        refreshControl={
          <RefreshControl
      ...
      >
              ...
              <View className="flex-1 px-5 py-5">
                ...
                {isLoading ? (
                  ...
                  <Text className="mt-2 text-3xl font-extrabold text-gray-900">
                    Rp{" "}
                    {Math.round(stats.totalSalesToday).toLocaleString("id-ID")}
                  </Text>
                )}
        ...
        <View className="px-6 mt-2">
          <Text className="text-base tracking-widest text-gray-400 font-bold mt-4 pl-2 border-l-2 border-gray-600">
            CATATAN TERBARU
          </Text>
          ...
          <View className="mt-6 gap-4">
            ...
            {!isLoading && !error && todayFiltered.length === 0 && (
              <View className="bg-white rounded-3xl border border-gray-100 shadow-sm p-5">
                ...
                >
                  ...
                  <View className="mt-4 px-5 pb-5">
                    ...
                    <View className="flex-row items-center justify-between mt-4">
                        ...
                        <View className="w-12 h-12 rounded-2xl bg-gray-50 border border-gray-100 items-center justify-center">
                          {r.paymentMethodLabel.toUpperCase() === "CASH" ? (
                            <Ionicons
                              ...
                              color="#1F2937"
                            />
                          ) : r.paymentMethodLabel.toUpperCase() ===
                            "KASBON" ? (
                            <Ionicons
                      ...
                      >
                        <Text className="text-sm font-semibold text-gray-500 mr-1">
                          Details
                        </Text>
                        <Ionicons
      ...
      >
        <View className="pb-6">
          ...
          >
            <View className="flex-row items-center justify-between">
              <Text
                className={`font-medium ${filter === "all" ? "text-gray-900" : "text-gray-600"}`}
              >
                All
              </Text>
              {filter === "all" && (
          ...
          >
            <View className="flex-row items-center justify-between">
              <Text
                className={`font-medium ${filter === "completed" ? "text-gray-900" : "text-gray-600"}`}
              >
                Completed
              </Text>
              {filter === "completed" && (
          ...
          >
            <View className="flex-row items-center justify-between">
              <Text
                className={`font-medium ${filter === "pending" ? "text-gray-900" : "text-gray-600"}`}
              >
                Pending
              </Text>
              {filter === "pending" && (
